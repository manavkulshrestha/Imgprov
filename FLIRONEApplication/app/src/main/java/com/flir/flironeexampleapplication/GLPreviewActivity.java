...
public class GLPreviewActivity extends Activity implements Device.Delegate, FrameProcessor.Delegate, Device.StreamDelegate, Device.PowerUpdateDelegate{
    ...
    public void onFrameProcessed(final RenderedImage renderedImage){
        ...
        thermalBitmap = renderedImage.getBitmap();//update new captured frame

        //if stream is required
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try{
                        ...
                        renderedImage.getFrame().save(new File(lastSavedPath), frameProcessor);//capture and save image
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            thermalSurfaceView.animate().setDuration(50).scaleY(0).withEndAction((new Runnable() {
                                public void run() {
                                    thermalSurfaceView.animate().setDuration(50).scaleY(1);
                                }
                            }));
                        }
                    });
